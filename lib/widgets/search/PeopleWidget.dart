...
class PeopleWidget extends StatelessWidget {
  ...
  const PeopleWidget({super.key, required this.targetUserId});
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Card(
        ...
        shadowColor: Colors.grey.withOpacity(0.3), // Màu bóng
          ...
          child: Row(
            children: [
              ...
              CircleAvatar(
                ...
                backgroundImage: const NetworkImage('https://picsum.photos/200/300?random=1'),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      'User Name', // Thay thế bằng tên người dùng thực tế
                      style: TextStyle(
                    ...
                    Text(
                      'user@example.com', // Thay thế bằng email thực tế
                      style: TextStyle(
